...
(defun make-2d-texture-from-buffer (image-pointer width height)
  (let* ((gl-texture (gl:gen-texture)))
    (gl:bind-texture :texture-2d gl-texture)
    (gl:tex-parameter :texture-2d :texture-wrap-s :repeat)
    (gl:tex-parameter :texture-2d :texture-wrap-t :repeat)
    (gl:tex-parameter :texture-2d :texture-min-filter :linear-mipmap-linear)
    (gl:tex-parameter :texture-2d :texture-mag-filter :linear)
    (gl:tex-image-2d :texture-2d 0 :rgba width height 0 :rgba :unsigned-byte image-pointer)
    (gl:generate-mipmap :texture-2d)
    gl-texture))

(defun bind-update-2d-texture-from-buffer (gl-texture image-pointer width height)
  (gl:bind-texture :texture-2d gl-texture)
  (gl:tex-parameter :texture-2d :texture-wrap-s :repeat)
  (gl:tex-parameter :texture-2d :texture-wrap-t :repeat)
  (gl:tex-parameter :texture-2d :texture-min-filter :linear-mipmap-linear)
