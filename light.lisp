...
void main(){
  ...
  vec3 specular_light = specular_coef * specular * light_color;

  vec3 obj_color = vec3(texture(tex, tex_coord));
  color = (ambient_light + diffuse_light + specular_light) * obj_color;
}
")
